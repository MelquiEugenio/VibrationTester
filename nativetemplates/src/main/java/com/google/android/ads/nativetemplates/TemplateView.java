...
public class TemplateView extends FrameLayout {
  ...
  private void initView(Context context, AttributeSet attributeSet) {
    ...
    TypedArray attributes =
        context.getTheme().obtainStyledAttributes(attributeSet, R.styleable.gnt_template_view, 0, 0);

    int templateType;
    try {
      templateType =
          attributes.getResourceId(
              R.styleable.gnt_template_view_gnt_template_type, R.layout.gnt_medium_template_view);
    } finally {
      attributes.recycle();
    }
